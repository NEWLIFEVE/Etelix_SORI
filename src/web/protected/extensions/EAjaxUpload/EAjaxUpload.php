...
class EAjaxUpload extends CWidget
{
	...
	public $css=null;
		...
		{
		      throw new CException('EAjaxUpload: param "action" no puede estar vacio.');
                }

		if(empty($this->config['allowedExtensions']))
		{
		      throw new CException('EAjaxUpload: param "allowedExtensions" no puede estar vacio.');
                }

		if(empty($this->config['sizeLimit']))
		{
		      throw new CException('EAjaxUpload: param "sizeLimit" no puede estar vacio.');
                }

                unset($this->config['element']);

                echo '<div id="'.$this->id.'"><noscript><p>Por favor activar JavaScript para subir archivos.</p></noscript></div>';
