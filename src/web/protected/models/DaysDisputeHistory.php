...
/**
 * This is the model class for table "days_dispute_history".
 *
 * The followings are the available columns in table 'days_dispute_history':
 * @property integer $id
 ...
 */
class DaysDisputeHistory extends CActiveRecord
{
	/**
	...
	public function rules()
	{
		...
		return array(
			array('start_date, id_contrato, days', 'required'),
	 ...
	 * @return DaysDisputeHistory the static model class
	 */
