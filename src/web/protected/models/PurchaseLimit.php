...
/**
 * This is the model class for table "purchase_limit".
 *
 * The followings are the available columns in table 'purchase_limit':
 * @property integer $id
 ...
 */
class PurchaseLimit extends CActiveRecord
{
	/**
	 ...
	 * @return PurchaseLimit the static model class
	 */
